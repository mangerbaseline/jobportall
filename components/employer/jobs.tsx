                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  ...
                  <div className="flex items-start gap-4 flex-1 min-w-0">
                    ...
                    <div className="min-w-0">
                      <h4 className="font-bold text-foreground text-base group-hover:text-primary transition-colors truncate">
                        {job.title}
                      </h4>
                      {job.company?.name && (
                        <p className="text-xs text-primary/70 font-medium mt-0.5 truncate flex items-center gap-1">
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-violet-500/10 border border-violet-500/20">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-xs text-violet-500/60 uppercase tracking-wider">
                          Open
                        </div>
                      </div>
                    </div>
