  ...
  return (
    <div className="w-full space-y-6 animate-fade-up">
                ...
                ? queries.map((query) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm text-white/80 line-clamp-1 max-w-[250px]">
                          {query.subject}
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right">
                        <button
                          ...
                          className="px-3 py-1.5 text-xs font-medium text-indigo-400 bg-indigo-500/10 border border-indigo-500/20 rounded-lg hover:bg-indigo-500/20 transition-all"
                        >
                          View Details
                        </button>
                      </td>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] bg-[#0B0F1A] border-white/10 text-white p-0 overflow-hidden shadow-2xl">
          <DialogHeader className="p-6 border-b border-white/10 bg-white/2">
          ...
          <div className="p-6 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2.5 mt-1.5">
                  <div className="w-9 h-9 rounded-xl bg-indigo-500/10 flex items-center justify-center text-indigo-400 text-xs font-bold border border-indigo-500/20 shadow-inner">
              ...
              {selectedQuery?.phone && (
                <div className="space-y-1">
                  ...
                  <p className="text-sm mt-2 text-white/70 font-medium tracking-wide">
                    {selectedQuery.phone}
                  </p>
                </div>
              )}
              <div className="space-y-1">
                ...
                <p className="text-sm mt-2 text-white/70 flex items-center gap-2">
            ...
            <div className="space-y-2">
              ...
              <div className="p-3.5 rounded-xl bg-white/5 border border-white/10 text-sm font-bold text-white tracking-tight leading-snug shadow-sm">
            ...
            <div className="space-y-2">
              ...
              <div className="p-5 rounded-2xl bg-white/2 border border-white/5 text-sm text-white/60 leading-relaxed whitespace-pre-wrap min-h-[140px] shadow-inner font-light">
          ...
          <div className="p-5 bg-white/2 border-t border-white/5 flex justify-end">
            <button
              ...
              className="px-6 py-2.5 text-xs font-bold text-white/50 hover:text-white uppercase tracking-widest transition-all"
            >
              Close
            </button>
          </div>
